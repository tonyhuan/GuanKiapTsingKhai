...
## 說明
1. 結合「芫荽」(ButTaiwan)與「霞鶩文楷輕便版」(lxgw)的字型，只有Regular字重，使用方便的「中文字型簡繁處理工具」(GuiWonder)專案合併轉換。
...
- 「中文字型簡繁處理工具」[https://github.com/GuiWonder/TCFontCreator]
...
## 最新版本
V1.11 - (2023/06/08) 對應芫荽及霞鶩新版字型做增字改版。
